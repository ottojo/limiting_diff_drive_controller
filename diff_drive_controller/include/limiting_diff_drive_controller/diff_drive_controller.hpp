...
#include "limiting_diff_drive_controller/visibility_control.h"
...
#include <limiting_diff_drive_controller/limiting_diff_drive_controller_parameters.hpp>

namespace limiting_diff_drive_controller
{
class LimitingDiffDriveController : public controller_interface::ControllerInterface
{
  using Twist = geometry_msgs::msg::TwistStamped;

public:
  DIFF_DRIVE_CONTROLLER_PUBLIC
  LimitingDiffDriveController();
